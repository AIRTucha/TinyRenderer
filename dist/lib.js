...
/** @constructor */
function $c_Ltinyrenderer_TinyRenderer$() {
  $c_O.call(this)
}
$c_Ltinyrenderer_TinyRenderer$.prototype = new $h_O();
$c_Ltinyrenderer_TinyRenderer$.prototype.constructor = $c_Ltinyrenderer_TinyRenderer$;
/** @constructor */
function $h_Ltinyrenderer_TinyRenderer$() {
  /*<skip>*/
}
$h_Ltinyrenderer_TinyRenderer$.prototype = $c_Ltinyrenderer_TinyRenderer$.prototype;
$c_Ltinyrenderer_TinyRenderer$.prototype.init___ = (function() {
  return this
});
$c_Ltinyrenderer_TinyRenderer$.prototype.main__V = (function() {
  ...
  ctx.lineWidth = 3.0;
  ctx.beginPath();
  ctx.moveTo((($uI(canvas.width) / 3) | 0), 0.0);
  ctx.lineTo((($uI(canvas.width) / 3) | 0), (($uI(canvas.width) / 3) | 0));
  ctx.moveTo(((($uI(canvas.width) << 1) / 3) | 0), 0.0);
  ctx.lineTo(((($uI(canvas.width) << 1) / 3) | 0), (($uI(canvas.width) / 3) | 0));
  ctx.moveTo($uI(canvas.width), (($uI(canvas.width) / 2) | 0));
  ctx.arc((($uI(canvas.width) / 2) | 0), (($uI(canvas.width) / 2) | 0), (($uI(canvas.width) / 2) | 0), 0.0, 3.14);
  ctx.stroke();
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("main").appendChild(canvas)
});
$c_Ltinyrenderer_TinyRenderer$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Ltinyrenderer_TinyRenderer$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Ltinyrenderer_TinyRenderer$ = new $TypeData().initClass({
  Ltinyrenderer_TinyRenderer$: 0
}, false, "tinyrenderer.TinyRenderer$", {
  Ltinyrenderer_TinyRenderer$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Ltinyrenderer_TinyRenderer$.prototype.$classData = $d_Ltinyrenderer_TinyRenderer$;
var $n_Ltinyrenderer_TinyRenderer$ = (void 0);
function $m_Ltinyrenderer_TinyRenderer$() {
  if ((!$n_Ltinyrenderer_TinyRenderer$)) {
    $n_Ltinyrenderer_TinyRenderer$ = new $c_Ltinyrenderer_TinyRenderer$().init___()
  };
  return $n_Ltinyrenderer_TinyRenderer$
}
/** @constructor */
...
$e.tinyrenderer.TinyRenderer = $m_Ltinyrenderer_TinyRenderer$;
$m_Ltinyrenderer_TinyRenderer$().main__V();
}).call(this);
